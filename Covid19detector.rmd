...
covar <- read_csv("Data Science/Covid19/Kaggle/ccaa_covid19_casos_long.csv")
covar1 <- covar
...
sp <- subset(covar, fecha>= "2020-04-30" & fecha <= "2020-05-06")
...
sp <- subset(covar, fecha>= "2020-03-08" & fecha <= "2020-03-14")
...
sp <- subset(covar, fecha>= "2020-05-01" & fecha <= "2020-05-07")
...
detector <- filter(Spain1, pct_change >=36.25827 )
detector
