...
corona_latest$`Country/Region`[corona_latest$`Country/Region`  == "UK"] = "United Kingdom of Great Britain and Northern Ireland"
...
map_death <- world +
  ...
  labs(size = 'Casos confirmados')+   theme( plot.title = element_text(hjust = 0.5 , face = "bold", size = 25),
